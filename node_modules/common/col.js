...
class Col{
   ...
   /** @type {import("common/col").TColType} */ data_type
   /** @type {Fk} */ fk

   /** @param {import("common/col").DbCol} col_data */
   constructor(col_data){
      // console.log('default', col_data.column_default);
      // console.log('is_nullable', col_data.is_nullable);
...
/**
 * @param {import("common/col").DbCol} col
 * @returns {import("common/col").TColType}
 */
